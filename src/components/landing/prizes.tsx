  ...
  return (
    <section id="prizes" className="container mx-auto px-4 py-12">
      <Card 
        ...
        onClick={handleClick}
        className={cn(
          "relative p-8 text-center max-w-7xl mx-auto overflow-hidden transition-all flex flex-col min-h-[400px]",
        ...
        <div className="flex-1 flex flex-col justify-center">
          <div className="flex justify-center mb-8">
            <div className="p-4 rounded-full bg-yellow-500/20">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-yellow-500" aria-hidden="true">
                <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
              </svg>
            </div>
          </div>
          
          <h3 className="text-2xl font-bold uppercase tracking-tight mb-4 text-transparent bg-clip-text bg-linear-to-r from-yellow-400 to-accent">
            {dict.prizes.title}
          </h3>
